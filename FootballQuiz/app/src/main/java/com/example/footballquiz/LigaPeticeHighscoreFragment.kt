...
class LigaPeticeHighscoreFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ligapetice_highscore, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonPokreni.setOnClickListener {
            fragmentManager?.beginTransaction()
                ?.replace(R.id.fragmentContainer, LigaPeticeEasyFragment())?.commit()
        }
            ...
            query.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    for (snapshot in dataSnapshot.children) {
                        val rezultat = snapshot.child("liga_petice_score").value as? Long
                        val maxRezultat = snapshot.child("liga_petice_highScore").value as? Long
