...
class SpiEpHighscoreFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_spiep_highscore, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonPokreni.setOnClickListener {
            fragmentManager?.beginTransaction()
                ?.replace(R.id.fragmentContainer, SpiEpEasyFragment())?.commit()
        }
            ...
            query.addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    for (snapshot in dataSnapshot.children) {
                        val rezultat = snapshot.child("spiep_score").value as? Long
                        val maxRezultat = snapshot.child("spiep_highScore").value as? Long
